  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mt-4 mb-2">Ingredients</h1>
        <p className="text-gray-600">Browse all available ingredients and discover delicious meals</p>
      </div>
